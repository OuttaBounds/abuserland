...
i686-w64-mingw32-gcc abuserland.c -m32 hooknt.x86.dll.o hooknt.x64.dll.o injector.x86.exe.o injector.x64.exe.o -std=c99 -s -Os -municode -Wall -Werror -o bin/abuserland.x86.exe
...
x86_64-w64-mingw32-gcc abuserland.c hooknt.x86.dll.o hooknt.x64.dll.o injector.x86.exe.o injector.x64.exe.o -std=c99 -s -Os -municode -Wall -Werror -o bin/abuserland.x64.exe
